...
#include "SpatialiteXS.h"

DBISTATE_DECLARE;

MODULE = DBD::Spatialite          PACKAGE = DBD::Spatialite::db

PROTOTYPES: DISABLE

BOOT:
    sv_setpv(get_sv("DBD::Spatialite::sqlite_version", TRUE|GV_ADDMULTI), SQLITE_VERSION);
    sv_setpv(get_sv("DBD::Spatialite::spatialite_version",TRUE|GV_ADDMULTI), SPATIALITE_VERSION);

IV
last_insert_rowid(dbh)
    SV *dbh
    ALIAS:
        DBD::Spatialite::db::x_spatialite_last_insert_rowid = 1
    CODE:
    {
        D_imp_dbh(dbh);
...
create_function(dbh, name, argc, func)
    ...
    SV *func
    ALIAS:
        DBD::Spatialite::db::x_spatialite_create_function = 1
    CODE:
    {
...
enable_load_extension(dbh, onoff)
    ...
    int onoff
    ALIAS:
        DBD::Spatialite::db::x_spatialite_enable_load_extension = 1
    CODE:
    {
...
create_aggregate(dbh, name, argc, aggr)
    ...
    SV *aggr
    ALIAS:
        DBD::Spatialite::db::x_spatialite_create_aggregate = 1
    CODE:
    {
...
create_collation(dbh, name, func)
    ...
    SV *func
    ALIAS:
        DBD::Spatialite::db::x_spatialite_create_collation = 1
    CODE:
    {
...
collation_needed(dbh, callback)
    ...
    SV *callback
    ALIAS:
        DBD::Spatialite::db::x_spatialite_collation_needed = 1
    CODE:
    {
...
progress_handler(dbh, n_opcodes, handler)
    ...
    SV *handler
    ALIAS:
        DBD::Spatialite::db::x_spatialite_progress_handler = 1
    CODE:
    {
...
commit_hook(dbh, hook)
    ...
    SV *hook
    ALIAS:
        DBD::Spatialite::db::x_spatialite_commit_hook = 1
    CODE:
    {
...
rollback_hook(dbh, hook)
    ...
    SV *hook
    ALIAS:
        DBD::Spatialite::db::x_spatialite_rollback_hook = 1
    CODE:
    {
...
update_hook(dbh, hook)
    ...
    SV *hook
    ALIAS:
        DBD::Spatialite::db::x_spatialite_update_hook = 1
    CODE:
    {
...
busy_timeout(dbh, timeout=0)
    ...
    int timeout
    ALIAS:
        DBD::Spatialite::db::x_spatialite_busy_timeout = 1
    CODE:
...
backup_from_file(dbh, filename)
    ...
    char *filename
    ALIAS:
        DBD::Spatialite::db::x_spatialite_backup_from_file = 1
    CODE:
...
backup_to_file(dbh, filename)
    ...
    char *filename
    ALIAS:
        DBD::Spatialite::db::x_spatialite_backup_to_file = 1
    CODE:
        RETVAL = sqlite_db_backup_to_file(aTHX_ dbh, filename);
    OUTPUT:
        RETVAL

MODULE = DBD::Spatialite          PACKAGE = DBD::Spatialite::st

PROTOTYPES: DISABLE

MODULE = DBD::Spatialite          PACKAGE = DBD::Spatialite

...
$DBD::Spatialite::COLLATION{no_accents} = \&no_accents;
...
dies (sub {$DBD::Spatialite::COLLATION{perl} = sub {}},
      qr/already registered/,
      "can't override builtin perl collation");

dies (sub {delete $DBD::Spatialite::COLLATION{perl}},
...
$DBD::Spatialite::COLLATION{foo} = \&by_num;
dies (sub {$DBD::Spatialite::COLLATION{foo} = \&by_num_desc},
      qr/already registered/,
      "can't override registered collation");
my $tied = tied %DBD::Spatialite::COLLATION;
delete $tied->{foo};
$DBD::Spatialite::COLLATION{foo} = \&by_num_desc; # override, no longer dies
is($DBD::Spatialite::COLLATION{foo}, \&by_num_desc, "overridden collation");

...
foreach my $call_func (@CALL_FUNCS) {
  ...
  is($update_args[0], DBD::Spatialite::INSERT, 'update hook arg 0: INSERT');
  ...
  my $authorizer = sub {
    ...
    my $retval = $action_code == DBD::Spatialite::DELETE ? DBD::Spatialite::DENY
                                                     : DBD::Spatialite::OK;
    return $retval;
  };
  ...
  is_deeply(\@authorizer_args, 
            [DBD::Spatialite::INSERT, 'hook_test', undef, 'temp', undef],
  ...
  is_deeply(\@authorizer_args, 
            [DBD::Spatialite::DELETE, 'hook_test', undef, 'temp', undef],
